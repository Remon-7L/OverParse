...
namespace Ov3rD4r53
{
    ...
    class CustomSettingsProvider : SettingsProvider
    {
        ...
        {
            Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\0v3rD4r53");
        ...
        /// </summary>
        private string UserConfigPath => Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\0v3rD4r53\\user.config";
